...
def list_garants(argument):
    ...
    try:
        ...
        if argument == "prime_m":
            ...
            g_content['columns'] = ['ح.ب.ج', 'اســـم الكفيل', 'لقب الكفيل', 'ت. الميلاد', 'مبلغ المنحة الشهرية',
                                    'معلومات حول']
            ...
            for person in g_list:
                ...
                if value:
                    ...
                    person.Solde_part_financiere = value
            g_content['data'] = concerned
            g_content['columns'] = ['ح.ب.ج', 'اســـم الكفيل', 'لقب الكفيل', 'ت. الميلاد', 'مبلغ منحة التمدرس',
                                    'معلومات حول']
            return render_template('list_garants.html', content=g_content, amounts=amounts)
...
@app.route("/mosque/update", methods=['GET', 'POST'])
@login_required
def update_info(arg):
